...
{
        var cambio = eval( parseFloat( document.getElementById(us).value.replace(/\./g, "").replace(",", ".") ) * document.getElementById(ct).value )  ;
        document.getElementById(gs).value = ( number_format( cambio,0, ',', '.') )
}

function GsToUs(ct,gs,us)                                               //
{
        var cambio = eval( parseFloat( document.getElementById(gs).value.replace(/\./g, "") ) / document.getElementById(ct).value )  ;
        document.getElementById(us).value = ( number_format( cambio,2, ',', '.') )
}
