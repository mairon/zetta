class VendasController < ApplicationController
    ...
    def get_codigo_entrada_produto  #
        pd =  Produto.first(:select => 'id', :conditions =>  [ "fabricante_cod = ?", params[:codigo]])

        return render :text => "<script type='text/javascript'>
                                  document.getElementById('vendas_entrada_produto_produto_id').value = '#{pd.id.to_i}';
                                </script>"
    end
    ...
    def get_codigo                           #
        ...
        return render :text => "<script type='text/javascript'>
                              ...
                              document.getElementById('venda_tipo_maiorista').value       = '#{@persona.cliente.to_i}';
    ...
    def new_balcao                                  
        ...
        @venda = Venda.new(:persona_id => empresa.venda_persona_id, :persona_nome => empresa.venda_persona_nome,:data => Time.now,:cotacao => '4500',:pedido_id => 0)
        @venda.save
        redirect_to(@venda) 
    end
